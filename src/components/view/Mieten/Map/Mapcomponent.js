...
const { compose, withProps, withState, withStateHandlers, withHandlers } = require("recompose");
                  ...
                  <div style={{height: "350px", width: "250px"}}>
                        <div className="listing-shot grid-style">
                          <div className="listing-shot-img">
                            <img src={props.markers[props.selectedPlace].cardImage} stlye={{height:"150px"}} className="img-responsive" alt=""/>
                            <span className="listing-price">{props.markers[props.selectedPlace].price}€</span>
                          </div>
                          <div className="listing-shot-caption">
                            <h4>{props.markers[props.selectedPlace].cardHeading}</h4>
                            <span><i className="fa fa-map-marker" aria-hidden="true"></i>{props.markers[props.selectedPlace].standOrt}</span>
                          </div>
                          <a/>
                          ...
                          <div className="row extra">
                            ...
                            <Link to={{
                              pathname: `/details/search=${props.markers[props.selectedPlace].kategorie +"/"+props.markers[props.selectedPlace].id}`,
