...
class Vibrationsplatte extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
   ...
   event.preventDefault();
    ...
    if (this.state.imageFiles == []) {
      ...
      this.setState({alert: alert, showAlert: true})
        ...
        const db = firebase.database().ref('app').child('cards').child('vibrationsplatte');
                      ...
                      <div className="col-md-12 col-sm-12">
                        <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
            							<div className="listing-box-header">
            								...
            								<h3>Vibrationsplatte Inserieren</h3>
            							...
            							<form onSubmit={this.artikelHochladen.bind(this)}>
                            {
                              ...
                              <div className="col-sm-6">
                                ...
                                <input type="text" className="form-control" ref={(input) => { this.RuettelkraftdesArtikelsInput = input}} placeholder="in kN"/>
                              </div>
...
export default Vibrationsplatte;
