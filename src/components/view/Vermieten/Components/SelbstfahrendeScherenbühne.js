...
class SelbstfahrendeScherenbühne extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
   ...
   event.preventDefault();
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('selbstfahrendeScherenbühne');
                        ...
                        <div className="col-md-12 col-sm-12">
                          <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                            <div className="listing-box-header">
                              ...
                              <h3>Selbstfahrende-Scherenbühne Inserieren</h3>
                            ...
                            <form onSubmit={this.artikelHochladen.bind(this)}>
                              ...
                              <div className="row mrg-r-10 mrg-l-10">
                                <div className="col-sm-6">
                                  <label>Model</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.titelInput = input}} placeholder="Bsp: S-1930" />
                                </div>

                                <div className="col-sm-6">
                                  <label>Hersteler</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.herstellerInput = input}} placeholder="Bsp: Leonardo" />
                                </div>
...
export default SelbstfahrendeScherenbühne;
