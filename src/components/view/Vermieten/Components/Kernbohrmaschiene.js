...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    const alert = "Gebe Auskunft über die Bohrkrone"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
                              ...
                              <form onSubmit={this.artikelHochladen.bind(this)}>
                                ...
                                <div className="row mrg-r-10 mrg-l-10">
                                  ...
                                  <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" ref={(input) => { this.bohrkroneInput = input}} placeholder="Bsp: 120cm 160cm 200 cm"/>
                                  </div>
