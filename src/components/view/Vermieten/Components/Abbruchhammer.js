                          ...
                          <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
              							...
              							<form onSubmit={this.artikelHochladen.bind(this)}>
                              {
                                ...
                                :(null)
              								...
              								<div className="row mrg-r-10 mrg-l-10">
              									...
              									<div className="col-sm-6">
              										...
              										<input type="text" className="form-control"  ref={(input) => { this.herstellerInput = input}} placeholder="Bsp: Hilti" />
              									</div>
                                ...
                                <div className="col-sm-6">
              										...
              										<input type="text" className="form-control" ref={(input) => { this.einzelschlagstärkeInput = input}} placeholder="Bsp: 7,5 Joule"/>
              									</div>
