...
class Grabenwalze extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    const alert = "Gebe Auskunft über die Bandagenbreite"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    if (this.ruettelkraftInput.value == "") {
    const alert = "Gebe Auskunft über die Rüttelkraft"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('grabenwalze');
                              ...
                              <form onSubmit={this.artikelHochladen.bind(this)}>
                                ...
                                <div className="row mrg-r-10 mrg-l-10">
                                  ...
                                  <div className="col-sm-6">
                                    ...
                                    <input type="number" ref={(input) => { this.bandagenbreiteInput  = input}} className="form-control" placeholder="in cm"/>
                                  </div>
