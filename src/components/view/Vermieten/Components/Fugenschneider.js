...
class Fugenschneider extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('fugenschneider');
  ...
  {this.state.loading?(<div className="loader"></div>):(
                          ...
                          <div className="col-md-12 col-sm-12">
                            <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                              <div className="listing-box-header">
                                ...
                                <h3>Fugenschneider Inserieren</h3>
              ...
              <div className="col-sm-6">
                ...
                <input type="number" className="form-control" ref={(input) => { this.schnitttiefeInput = input}} placeholder="in cm"/>
              </div>
