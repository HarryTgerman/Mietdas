...
class GelenkteleskoparbeitsbühneAufGummiketten extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    const alert = "Gebe Auskunft über das Gesamtgewicht"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    const alert = "Gebe Auskunft über die Arbeitshöhe"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    const alert = "Gebe Auskunft über die Plattform"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    if (this.AbstüzbreiteInput.value == "") {
    const alert = "Gebe Auskunft über die Abstüzbreite"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    if (this.AbstüzlängeInput.value == "") {
    const alert = "Gebe Auskunft über die Abstüzlänge"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('gelenkteleskoparbeitsbühneAufGummiketten');
        ...
        Promise.all(keysPromises).then(() => {
               ...
               db.push({
                         ...
                         gewicht:gewicht,
                         kategorie:"gelenkteleskoparbeitsbühneAufGummiketten",
                         email: this.props.email,
                         hersteller: hersteller,
                         gesamtbreite: gesamtbreite,
                         gesamthoehe: gesamthoehe,
                         arbeitshoehe: arbeitshoehe,
                         abstuetzbreite: abstuetzbreite,
                         abstuetzlaenge: abstuetzlaenge,
                         plattform: plattform,
                         traglast: traglast,
                         antrieb: antrieb,
                         cardHeading:titel ,
                        ...
                        <div className="col-md-12 col-sm-12">
                          <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                            <div className="listing-box-header">
                              ...
                              <h3>Gelenkteleskoparbeitsbühne auf Gummiketten Inserieren</h3>
                            ...
                            <form onSubmit={this.artikelHochladen.bind(this)}>
                              ...
                              <div className="row mrg-r-10 mrg-l-10">
                                <div className="col-sm-6">
                                  <label>Model</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.titelInput = input}} placeholder="Bsp: E23" />
                                </div>

                                <div className="col-sm-6">
                                  <label>Hersteler</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.herstellerInput = input}} placeholder="Bsp: Octopus" />
                                </div>
                                ...
                                <div className="col-sm-6">
                                  <label>Antrieb</label>
                                  <input type="text" className="form-control" ref={(input) => { this.AntriebInput = input}} placeholder="Bsp: Benzin"/>
                                </div>
...
export default GelenkteleskoparbeitsbühneAufGummiketten;
