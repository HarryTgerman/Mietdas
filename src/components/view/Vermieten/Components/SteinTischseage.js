...
class SteinTischseage extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    if (this.bedienungInput.value == "") {
      const alert = "Gebe Auskunft über die Bedienung"
      this.setState({alert: alert, showAlert: true})
      return 0
    }
    ...
    const alert = "Lade ein Datenblatt hoch"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('steinTischseage');
                      ...
                      <div className="col-md-12 col-sm-12">
                        <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
            							<div className="listing-box-header">
            								...
            								<h3>Stein-Tischsäge Inserieren</h3>
...
export default SteinTischseage;
