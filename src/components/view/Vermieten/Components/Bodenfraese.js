...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    if (this.fraeseInput.value == "") {
    const alert = "Gebe Auskunft über die Frästiefe"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const fraese = this.fraeseInput.value;
                          ...
                          <form onSubmit={this.artikelHochladen.bind(this)}>
                            ...
                            <div className="row mrg-r-10 mrg-l-10">
                              ...
                              <div className="col-sm-6">
                                ...
                                <input type="number" className="form-control" ref={(input) => { this.fraeseInput = input}} placeholder="in cm"/>
                              </div>

                              <div className="col-sm-6">
                                <label>Motor</label>
                                <input type="text" className="form-control" ref={(input) => { this.motorInput = input}} placeholder="Bsp: 4-Takt Benzinmotor"/>
                              </div>
