...
class Radlader extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    const alert = "Gebe Auskunft über die Schütthöhe"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    if (this.SchaufelinhaltdesArtikelsInput.value == "") {
    const alert = "Gebe Auskunft über den Schaufelinhalt"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('radlader');
                              ...
                              <form onSubmit={this.artikelHochladen.bind(this)}>
                                ...
                                <div className="row mrg-r-10 mrg-l-10">
                                  ...
                                  <div className="col-sm-6">
                                    ...
                                    <input type="number" className="form-control" ref={(input) => { this.SchaufelinhaltdesArtikelsInput = input}} placeholder="in m3"/>
                                  </div>
