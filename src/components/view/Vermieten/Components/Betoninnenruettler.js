...
class Betoninnenruettler extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    const alert = "Gebe Auskunft über die Schlauchlänge"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    if (this.spannungInput.value == "") {
    const alert = "Gebe Auskunft über die Spannung"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('betoninnenruettler');
                          ...
                          <div className="col-md-12 col-sm-12">
                            <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                              <div className="listing-box-header">
                                ...
                                <h3>Betoninnenrüttler Inserieren</h3>
...
export default Betoninnenruettler;
