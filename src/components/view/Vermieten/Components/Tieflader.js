...
class Tieflader extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
   ...
   event.preventDefault();
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('tieflader');
                                ...
                                <div className="row mrg-r-10 mrg-l-10">
                                  ...
                                  <div className="col-sm-6">
                                    <label>Auflaufbremse</label>
                                      <select  className="form-control" ref={select => this.AuflaufbremsedesArtikelsInput = select}  name="auflaufbremse">>
