...
class GelenkteleskopArbeitsbühne extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
   ...
   event.preventDefault();
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const db = firebase.database().ref('app').child('cards').child('gelenkteleskopArbeitsbühne');
                        ...
                        <div className="col-md-12 col-sm-12">
                          <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                            <div className="listing-box-header">
                              ...
                              <h3>Gelenkteleskop-Arbeitsbühne Inserieren</h3>
...
export default GelenkteleskopArbeitsbühne;
