...
class LkwArbeitsbühne extends Component{
  constructor(props){
    super(props)
    this.state = {
       redirect: false,
...
onDrop(imageFiles) {
 ...
 artikelHochladen(event) {
   ...
   event.preventDefault();
    ...
    if (this.ReichweiteInput.value == "") {
    const alert = "Gebe Auskunft über die Reichweite"
    this.setState({alert: alert, showAlert: true})
    return 0
    }
    ...
    this.setState({
      ...
      imageUpload: false,
        ...
        const reichweite = this.ReichweiteInput.value;
                        ...
                        <div className="col-md-12 col-sm-12">
                          <div className=" full-detail mrg-bot-25 padd-bot-30 padd-top-25">
                            <div className="listing-box-header">
                              ...
                              <h3>LKW-Arbeitsbühne Inserieren</h3>
                            ...
                            <form onSubmit={this.artikelHochladen.bind(this)}>
                              ...
                              <div className="row mrg-r-10 mrg-l-10">
                                <div className="col-sm-6">
                                  <label>Model</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.titelInput = input}} placeholder="Bsp: Topy 11.2" />
                                </div>

                                <div className="col-sm-6">
                                  <label>Hersteler</label>
                                  <input type="text" className="form-control"  ref={(input) => { this.herstellerInput = input}} placeholder="Bsp: Nissan" />
                                </div>
                                ...
                                <div className="col-sm-6">
                                  ...
                                  <input type="text" className="form-control" ref={(input) => { this.PlattformInput = input}} placeholder="z.B Länge: 0,60 m Breite: 1,20 m"/>
                                </div>
...
export default LkwArbeitsbühne;
